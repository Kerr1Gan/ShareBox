 ...
 * bottom sheet.
 */
public class SimpleBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public SimpleBottomSheetBehavior() {
    }

    public SimpleBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//    }
    ...
    View findScrollingChild(View view) {
        ...
        if (view instanceof ViewPager) {
            ...
            if (viewPager.getFocusedChild() != null) {
                return findScrollingChild(viewPager.getFocusedChild());
            }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, SimpleBottomSheetBehavior behavior) {
            super(superState);
    ...
    public static <V extends View> SimpleBottomSheetBehavior<V> from(V view) {
        ViewGroup.LayoutParams params = view.getLayoutParams();
        if (!(params instanceof CoordinatorLayout.LayoutParams)) {
            throw new IllegalArgumentException("The view is not a child of CoordinatorLayout");
        }
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params).getBehavior();
        if (!(behavior instanceof SimpleBottomSheetBehavior)) {
            throw new IllegalArgumentException("The view is not associated with BottomSheetBehavior");
        }
        return (SimpleBottomSheetBehavior<V>) behavior;
    }
