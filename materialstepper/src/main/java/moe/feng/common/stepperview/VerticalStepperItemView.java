...
public class VerticalStepperItemView extends FrameLayout {
    ...
    private void prepareViews(Context context) {
        ...
        mPointNumber = (TextView) inflateView.findViewById(R.id.stepper_number);
        mTitleText = (TextView) inflateView.findViewById(R.id.stepper_title);
        mSummaryText = (TextView) inflateView.findViewById(R.id.stepper_summary);
        mCustomView = (FrameLayout) inflateView.findViewById(R.id.stepper_custom_view);
        mPointFrame = (FrameLayout) inflateView.findViewById(R.id.stepper_point_frame);
        mRightContainer = (LinearLayout) inflateView.findViewById(R.id.stepper_right_layout);
        mDoneIconView = (ImageView) inflateView.findViewById(R.id.stepper_done_icon);
        mMarginBottomView = inflateView.findViewById(R.id.stepper_margin_bottom);
        mErrorIconView = (ImageView) inflateView.findViewById(R.id.stepper_error_icon);
